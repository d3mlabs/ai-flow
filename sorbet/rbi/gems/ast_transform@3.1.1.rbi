...
# pkg:gem/ast_transform#lib/ast_transform/version.rb:3
module ASTTransform
  class << self
    # pkg:gem/ast_transform#lib/ast_transform.rb:17
    def acronym(acronym); end

    # pkg:gem/ast_transform#lib/ast_transform.rb:13
    def acronyms; end

    # pkg:gem/ast_transform#lib/ast_transform.rb:22
    def install; end

    # pkg:gem/ast_transform#lib/ast_transform.rb:36
    def output_path; end

    # pkg:gem/ast_transform#lib/ast_transform.rb:34
...
#
# pkg:gem/ast_transform#lib/ast_transform/abstract_analysis.rb:26
class ASTTransform::AbstractAnalysis < ::ASTTransform::AbstractProcessor
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/abstract_analysis.rb:33
  def run(node); end
end
...
#
# pkg:gem/ast_transform#lib/ast_transform/abstract_processor.rb:10
class ASTTransform::AbstractProcessor < ::Parser::AST::Processor
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/abstract_processor.rb:23
  def on_ast_thunk(node); end

  # Used internally by Parser::AST::Processor to process each node. DO NOT OVERRIDE.
  #
  # pkg:gem/ast_transform#lib/ast_transform/abstract_processor.rb:14
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/abstract_processor.rb:35
...
#
# pkg:gem/ast_transform#lib/ast_transform/abstract_transformation.rb:20
class ASTTransform::AbstractTransformation < ::ASTTransform::AbstractProcessor
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/abstract_transformation.rb:27
  def run(node); end
end

# pkg:gem/ast_transform#lib/ast_transform.rb:10
ASTTransform::DEFAULT_OUTPUT_PATH = T.let(T.unsafe(nil), String)

# pkg:gem/ast_transform#lib/ast_transform/instruction_sequence.rb:4
module ASTTransform::InstructionSequence
  class << self
    # pkg:gem/ast_transform#lib/ast_transform/instruction_sequence.rb:13
    def source_to_transformed_iseq(source, source_path); end

    # pkg:gem/ast_transform#lib/ast_transform/instruction_sequence.rb:6
    def using_bootsnap_compilation?; end

    # pkg:gem/ast_transform#lib/ast_transform/instruction_sequence.rb:29
    def write(string, pathname); end

    # pkg:gem/ast_transform#lib/ast_transform/instruction_sequence.rb:23
...
module ASTTransform::InstructionSequence::Mixin
  # pkg:gem/ast_transform#lib/ast_transform/instruction_sequence/mixin.rb:11
...
#
# pkg:gem/ast_transform#lib/ast_transform/kwargs_builder.rb:20
...
#
# pkg:gem/ast_transform#lib/ast_transform/layout.rb:9
class ASTTransform::Layout
  # pkg:gem/ast_transform#lib/ast_transform/layout.rb:10
  def initialize; end
...
#
# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:28
class ASTTransform::LineAlignedEmitter
  # @param thunk_lowering [ThunkLowering] the lowering run ahead of emission.
  #
  # pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:45
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:54
...
# align.
#
# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:41
ASTTransform::LineAlignedEmitter::ASSIGNMENT_TYPES = T.let(T.unsafe(nil), Array)

# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:42
ASTTransform::LineAlignedEmitter::BLOCK_VALUE_TYPES = T.let(T.unsafe(nil), Array)

# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:36
...
# at its head line.
#
# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:35
...
#
# pkg:gem/ast_transform#lib/ast_transform/line_aligned_emitter.rb:31
...
#
# pkg:gem/ast_transform#lib/ast_transform/node.rb:21
class ASTTransform::Node < ::Parser::AST::Node
  class << self
    ...
    #
    # pkg:gem/ast_transform#lib/ast_transform/node.rb:38
    ...
    # @return [void]
    #
    # pkg:gem/ast_transform#lib/ast_transform/node.rb:27
    def register(type); end

    # pkg:gem/ast_transform#lib/ast_transform/node.rb:43
    def registry; end
  end
end
...
#
# pkg:gem/ast_transform#lib/ast_transform/source_parser.rb:11
class ASTTransform::SourceParser
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/source_parser.rb:16
  def initialize; end
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/source_parser.rb:27
  ...
  # @return [Parser::AST::Node] The AST.
  #
  # pkg:gem/ast_transform#lib/ast_transform/source_parser.rb:39
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/source_parser.rb:52
...
#
# pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:16
class ASTTransform::StatementRenderer
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:40
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:46
  ...
  class << self
    ...
    # rendered text.
    #
    # pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:24
    def for_tree(node); end

    private

    # pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:30
...
#
# pkg:gem/ast_transform#lib/ast_transform/statement_renderer.rb:18
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk.rb:18
class ASTTransform::Thunk < ::ASTTransform::Node
  # pkg:gem/ast_transform#lib/ast_transform/thunk.rb:28
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk.rb:53
  def body; end

  # Retrieves the Thunk's id.
  # @return [ASTTransform::Thunk::Id] The Id.
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk.rb:47
  def id; end
end
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk.rb:26
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:35
class ASTTransform::ThunkLowering
  ...
  #   one thunk diverge
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:93
  def lower(node); end

  private

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:194
  def body_first_line(body); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:183
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:200
  def check_placement_precedes_execution!(placement, executing_statement, following_statements); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:214
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:101
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:132
  def lower_expression(node, registry); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:150
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:113
  ...
  # call.
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:169
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:229
  def method_scope_assignments(node, names = T.unsafe(nil)); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:187
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:225
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:222
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:40
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:45
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:49
class ASTTransform::ThunkLowering::Registry
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:50
  def initialize; end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:78
  def hidden_names; end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:55
  def known?(id); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:67
  def name_for(id); end

  # @return [Symbol] the hidden lvar name allocated for +id+.
  #
  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:60
  def register(id, body); end

  # pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:71
...
#
# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:87
ASTTransform::ThunkLowering::SCOPE_BODY_INDEXES = T.let(T.unsafe(nil), Hash)

# pkg:gem/ast_transform#lib/ast_transform/thunk_lowering.rb:84
...
#
# pkg:gem/ast_transform#lib/ast_transform/transformation.rb:14
class ASTTransform::Transformation < ::ASTTransform::AbstractTransformation
  private

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:75
  ...
  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:44
  def next_child(node, index); end

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:40
  def previous_child(node, index); end

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:19
  def process_node(node); end

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:48
  def process_node_helper(node, previous_node); end

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:100
  def require_path(const_name); end

  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:87
  ...
  # pkg:gem/ast_transform#lib/ast_transform/transformation.rb:114
  def try_const_get(const_name); end
end

# pkg:gem/ast_transform#lib/ast_transform/transformation.rb:15
...
# moving text.
#
# pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:18
module ASTTransform::TransformationHelper
  ...
  class << self
    # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:23
    def included(base); end
  end
end

# pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:29
module ASTTransform::TransformationHelper::Methods
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:95
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:37
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:51
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:75
  ...
  # order.
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:114
...
#
# pkg:gem/ast_transform#lib/ast_transform/transformation_helper.rb:20
class ASTTransform::TransformationHelper::MissingLocationError < ::StandardError; end

# pkg:gem/ast_transform#lib/ast_transform/transformer.rb:7
class ASTTransform::Transformer
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformer.rb:12
  ...
  # @return [Parser::AST::Node] The AST.
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformer.rb:24
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformer.rb:42
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformer.rb:83
  ...
  #
  # pkg:gem/ast_transform#lib/ast_transform/transformer.rb:70
  def transform_file_source(source, file_path, _transformed_file_path); end
end

# pkg:gem/ast_transform#lib/ast_transform/version.rb:4
