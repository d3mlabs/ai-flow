...
module AiFlow
  ...
  class Dispatcher
    ...
    # @param segments [Array<CommentParser::Segment>]
    # @return [Hash{AiFlow::Command => Array<AiFlow::ModelSelection>}] the
    #   effective command => its selection (same shape as Agent#models_used,
    #   which will hold exactly this entry after the pass)
    sig { params(segments: T::Array[CommentParser::Segment]).returns(T::Hash[Command, T::Array[ModelSelection]]) }
